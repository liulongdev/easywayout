...
@end
const CGFloat kShowPopMenuViewConstant = 0;
const CGFloat kHiddenPopMenuViewConstant = -300;

const CGFloat kShowParkViewViewBottomConstant = 0;
const CGFloat kHiddenParkViewViewBottomConstant = 200;
